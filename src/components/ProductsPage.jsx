    ...
    <div className="p-8">
      ...
      <div className="flex justify-between items-start mb-8">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">
            Manage your gym’s complete product inventory including supplements,
            equipment, merchandise, and café items.
          </p>
        </div>
      ...
      <div className="grid grid-cols-4 gap-5 mb-8">
        <StatCard
          ...
          value={stats.total || "—"}
          subtitle={`${stats.active || 0} active, ${stats.inactive || 0} inactive`}
        />
        <StatCard
